...
const generator = function(request) {
  ...
  const contacts = {
    ...
    search: {
      _endpoint: ['contacts', 'search'],
      _request: request,

      /**
       * GET a search for customers. See the search documentation for more info:
       * https://desk.zoho.com/DeskAPIDocument#Search#Search_SearchContacts
       *
       * @param {object} opts Request options. Must include search `params`
       * @param {boolean} paginate If the system should attempt to auto-paginate the request
       *
    ...
    id: function(contactId) {
      return {
        ...
        /**
         * PATCH an update for this specific contact
         *
         * @param {object} opts Request options
         *
