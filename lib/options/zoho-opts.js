...
class ZohoOpts {
  /**
   * Create Zoho Desk options. The system will attempt to use envars for any values not explicitly provided in the
   * opts parameter
   *
  ...
  constructor(opts = {}) {
     ...
     * A previously generated refresh token used to generate API keys. REQUIRED
     *
     * Envar: `ZOHO_DESK__CODE`
     */
     this.code = opts.code || process.env.ZOHO_DESK__CODE;
     if (!this.code) throw new Error('No "code" option provided to ZohoOpts');
